...
class AnimeDetailReview extends StatelessWidget {
  @override
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Text(
                                snapshot.data.reviews[index].reviewer.username,
                              ...
                              Text(
                                snapshot.data.reviews[index].helpfulCount
                                        .toString() +
          ...
          return Center(
            child: InkWell(
              onTap: () => Navigator.pushReplacementNamed(context, 'review'),
              child: Card(
                child: Padding(
