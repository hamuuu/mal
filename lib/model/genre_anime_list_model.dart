class GenreAnimeListModel {
  ...
  GenreAnimeListModel.fromJson(Map<String, dynamic> json) {
    requestHash = json['request_hash'];
    requestCached = json['request_cached'];
    requestCacheExpiry = json['request_cache_expiry'];
    malUrl =
        json['mal_url'] != null ? new MalUrl.fromJson(json['mal_url']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.malUrl != null) {
      data['mal_url'] = this.malUrl.toJson();
    }
...
class MalUrl {
  ...
  MalUrl({this.malId, this.type, this.name, this.url});

  MalUrl.fromJson(Map<String, dynamic> json) {
    malId = json['mal_id'];
    type = json['type'];
    name = json['name'];
    url = json['url'];
